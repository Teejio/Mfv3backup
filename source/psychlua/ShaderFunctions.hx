...
class ShaderFunctions
{
	public static function implement(funk:FunkinLua)
	{
		...
		funk.addLocalCallback("setRGB", function(obj:String, r:String,g:String,b:String) {
			if(!ClientPrefs.data.shaders) return false;

			#if (!flash && MODS_ALLOWED && sys)

			var rgbR = FlxColor.fromString(r);
			var rgbG = FlxColor.fromString(g);
			var rgbB = FlxColor.fromString(b);
